...
export interface Selection {
  ...
  recoil_spring_assembly:   string | null;
}
  ...
  devtools(
    (set, get) => ({
      ...
      setComponent: (group, id) => {
        set(
          state => ({
            selection: { ...state.selection, [group]: id },
          }),
          false,
          'setComponent'
        );
      ...
      validateConfig: (validator) => {
        const result = validator(get().selection);
        set({ validationResult: result }, false, 'validateConfig');
      },
